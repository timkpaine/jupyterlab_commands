...
latex_documents = [
    (
        master_doc,
        "jupyterlab_commands.tex",
        "jupyterlab_commands Documentation",
        "Tim Paine",
        "manual",
    ),
]
...
def run_apidoc(_):
    ...
    jupyterlab_commands_dir = os.path.abspath(
        os.path.join(os.path.dirname(__file__), "..", "jupyterlab_commands")
    )
    ...
    subprocess.check_call(
        [cmd_path, "-E", "-M", "-o", out_dir, jupyterlab_commands_dir, "--force"]
    )
